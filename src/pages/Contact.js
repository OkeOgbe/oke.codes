            ...
            <Layout bgText='Hit me up.'>
                ...
                <div className={`sectionHeight alignOnly ${styles.contact}`}>
                    <div className="container">
                        <h2 className="sectionHead--mid textIsPink text--light">Leave a message.</h2>
                        <p className="sectionText--mid textIsWhite text--light mt-2 mb-0">I'll be in touch, that's a promise!</p>

                        <form className='mt-4' onSubmit={handleSubmit}>
                            <div className="">
                                <input type="text" className={styles.inputField} placeholder='Full Name'/>
                            </div>
                            ...
                            <button className="defaultBtn mt-3">Send Message
